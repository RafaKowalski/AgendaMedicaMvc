...
namespace AgendaMedicaMvc.Controllers
{
    public class MedicosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Specialization")] Medico medico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Specialization")] Medico medico)
        {
            if (id != medico.Id)
            {
                return NotFound();
